...
// Dùng chung model Location của hệ thống V1 (đã được đăng ký qua locationSchema ESM).
...
const getClubName = async (locationId) => {
...
const clubConflict = (personLocationId, stationLocationId, clubNameOverride) => {
...
module.exports = { Location, stationLocationId, getClubName, clubConflict, dataFilter };
